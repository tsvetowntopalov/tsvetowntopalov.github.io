(function() {
    ...
    ShootingStar.prototype.launchStar = function(options) {
        ...
        console.log("Launching shooting star. PARAMS: wW: " + this.wW + " - hW: " + this.hW + " - life: " + this.options.life + " - beamSize: " + this.options.beamSize + " - velocity: " + this.options.velocity);
    ...
    ShootingStar.prototype.launch = function(everyTime) {
        ...
        setInterval(function() {
            var options = {
                ...
                life: self.getRandom(1000, 500),
                beamSize: self.getRandom(700, 400),
                velocity: self.getRandom(6, 4)
            }
